...
numeroCarpetas=$(ls $2 | wc -l) #Cuenta todos los ficheros que hay en el directorio

if [ $numeroCarpetas -lt $3 ] #Entramos siempre que haya menos carpetas creadas del limite
then
    nuevaCarpeta=$(($numeroCarpetas+1)) #Por ejemplo, si tenemos 3 carpetas, crearemos la carpeta 4
