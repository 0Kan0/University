// ruleta.h
// La clase ruleta representa los datos de la ruleta
...
{
    private:
    int banca_, bola_, nLanzamientosBola_; //Dinero de la banca, valor de la bola y numero de lanzamientos
    ...
    Ruleta(Crupier crupier):crupier_(crupier) //Constructor
    {
        ...
        nLanzamientosBola_=0; //Inizializamos los lanzamientos en 0
    }
