...
class Dados
{
    ...
    public:
        ...
        void insertador(); //Muestra el valor de los dos dados en pantalla indicando con un texto el valor del dado1 y con otro texto el valor del dado2
        void extractor(); //Pide el valor del dado 1 del dado 2 enviándolos como parámetros a setDado1() y setDado2(). Pide el dado hasta que este sea correctamente introducido
};
